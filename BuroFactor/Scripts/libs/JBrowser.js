...
JBrowser.prototype.Convert = function () {
    //Convertir dateTime----------
    if (this.isIE) {
...
JBrowser.prototype.mobileAndTabletcheck = function () {
    var check = false;
...
JBrowser.prototype.popupcenter = function (window, url, title, width, height) {
